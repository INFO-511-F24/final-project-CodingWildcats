...
-   The dataset includes variables such as gender, smoking status, employment status, and marital status which are qualitative variables.
-   Other variables such as age, BMI, and glucose index are all quantitative.
