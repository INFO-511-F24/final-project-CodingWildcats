...
-   We trained 5 different machine learning models on this dataset
    -   Random Forest
    -   Decision Tree
...
-   The Support Vector Machine and Artificial Neural Network followed closely, with average accuracies of 96.03% and 95.93%, respectively. T
-   The Decision Tree model had the lowest performance, with an average accuracy of 92.21%.
